...
import {
  IconBase
} from "./chunk-BQ4MLPJU.js";
import {
  require_prop_types
} from "./chunk-HVCOGAJZ.js";
import {
  Portal
} from "./chunk-KLPTGCA6.js";
import {
  require_react_dom
...
// node_modules/primereact/image/image.esm.js
...
// node_modules/primereact/icons/refresh/index.esm.js
...
var ObjectUtils2 = function() {
  function ObjectUtils7() {
    _classCallCheck(this, ObjectUtils7);
  }
  _createClass(ObjectUtils7, null, [{
    key: "equals",
    ...
    key: "combinedRefs",
    value: function combinedRefs(innerRef, forwardRef9) {
      if (innerRef && forwardRef9) {
        if (typeof forwardRef9 === "function") {
          forwardRef9(innerRef.current);
        } else {
          forwardRef9.current = innerRef.current;
        }
      }
    }
  }, {
...
var RefreshIcon = React9.memo(React9.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
// node_modules/primereact/icons/searchminus/index.esm.js
...
var ObjectUtils3 = function() {
  function ObjectUtils7() {
    _classCallCheck2(this, ObjectUtils7);
  }
  _createClass2(ObjectUtils7, null, [{
    key: "equals",
    value: function equals(obj1, obj2, field) {
...
var SearchMinusIcon = React10.memo(React10.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React10.useState(inProps.id), _React$useState2 = _slicedToArray2(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
// node_modules/primereact/icons/searchplus/index.esm.js
...
var ObjectUtils4 = function() {
  function ObjectUtils7() {
    _classCallCheck3(this, ObjectUtils7);
  }
  _createClass3(ObjectUtils7, null, [{
    key: "equals",
    value: function equals(obj1, obj2, field) {
    ...
    value: function findLast(arr, callback) {
      ...
      if (this.isNotEmpty(arr)) {
        try {
          ...
          item = _toConsumableArray3(arr).reverse().find(callback);
        }
      }
      return item;
    }
...
var SearchPlusIcon = React11.memo(React11.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React11.useState(inProps.id), _React$useState2 = _slicedToArray3(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
// node_modules/primereact/icons/undo/index.esm.js
...
function _slicedToArray4(arr, i) {
  return _arrayWithHoles4(arr) || _iterableToArrayLimit4(arr, i) || _unsupportedIterableToArray$14(arr, i) || _nonIterableRest4();
}
function _typeof5(o) {
  "@babel/helpers - typeof";
...
function _toConsumableArray4(arr) {
  return _arrayWithoutHoles4(arr) || _iterableToArray4(arr) || _unsupportedIterableToArray$14(arr) || _nonIterableSpread4();
}
...
var ObjectUtils5 = function() {
  function ObjectUtils7() {
    _classCallCheck4(this, ObjectUtils7);
  }
  _createClass4(ObjectUtils7, null, [{
    key: "equals",
    value: function equals(obj1, obj2, field) {
    ...
    value: function findLast(arr, callback) {
      ...
      if (this.isNotEmpty(arr)) {
        try {
          ...
          item = _toConsumableArray4(arr).reverse().find(callback);
        }
      }
      return item;
    }
...
var UndoIcon = React13.memo(React13.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React13.useState(inProps.id), _React$useState2 = _slicedToArray4(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
function _slicedToArray5(arr, i) {
  return _arrayWithHoles5(arr) || _iterableToArrayLimit5(arr, i) || _unsupportedIterableToArray$15(arr, i) || _nonIterableRest5();
}
var usePrevious = function usePrevious2(newValue) {
  var ref = React14.useRef(void 0);
...
var useUnmountEffect2 = function useUnmountEffect3(fn) {
  return React14.useEffect(function() {
    return fn;
  }, []);
};
var useEventListener = function useEventListener2(_ref) {
  ...
  var targetRef = React14.useRef(null);
  var listenerRef = React14.useRef(null);
...
var useOnEscapeKey = function useOnEscapeKey2(ref, condition, callback) {
  ...
  var _useEventListener = useEventListener({
    type: "keydown",
    listener: handleEsc
  }), _useEventListener2 = _slicedToArray5(_useEventListener, 2), bindKeyDownListener = _useEventListener2[0], unbindKeyDownListener = _useEventListener2[1];
  React14.useEffect(function() {
    if (!condition) {
      return;
    }
...
var ObjectUtils6 = function() {
  function ObjectUtils7() {
    _classCallCheck5(this, ObjectUtils7);
  }
  _createClass5(ObjectUtils7, null, [{
    key: "equals",
    value: function equals(obj1, obj2, field) {
    ...
    value: function findLast(arr, callback) {
      ...
      if (this.isNotEmpty(arr)) {
        try {
          ...
          item = _toConsumableArray5(arr).reverse().find(callback);
        }
      }
      return item;
    }
    ...
    key: "mutateFieldData",
    value: function mutateFieldData(data, field, value) {
      if (_typeof6(data) !== "object" || typeof field !== "string") {
        return;
      }
      var fields = field.split(".");
      var obj = data;
...
var DownloadIcon = React14.memo(React14.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var inlineStyles = {
  preview: function preview(_ref2) {
    var rotateState = _ref2.rotateState, scaleState = _ref2.scaleState;
    return {
...
var Image = React14.memo(React14.forwardRef(function(inProps, ref) {
  var context = React14.useContext(PrimeReactContext);
  var props = ImageBase.getProps(inProps, context);
  var _React$useState = React14.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React14.useState(false), _React$useState4 = _slicedToArray5(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React14.useState(0), _React$useState6 = _slicedToArray5(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React14.useState(1), _React$useState8 = _slicedToArray5(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  var elementRef = React14.useRef(null);
  var imageRef = React14.useRef(null);
  var maskRef = React14.useRef(null);
  var previewRef = React14.useRef(null);
  var previewClick = React14.useRef(false);
  ...
  }), ptm = _ImageBase$setMetaDat.ptm, cx = _ImageBase$setMetaDat.cx, sx = _ImageBase$setMetaDat.sx, isUnstyled = _ImageBase$setMetaDat.isUnstyled;
  ...
  var onPreviewImageClick = function onPreviewImageClick2() {
    previewClick.current = true;
  };
  var onDownload = function onDownload2() {
    var name = props.alt, src2 = props.src;
    DomHandler.saveAs({
      name,
      src: src2
    });
  ...
  var rotateRight = function rotateRight2() {
    setRotateState(function(prevRotate) {
      return prevRotate + 90;
    });
    previewClick.current = true;
  };
  var rotateLeft = function rotateLeft2() {
    setRotateState(function(prevRotate) {
      return prevRotate - 90;
    });
    previewClick.current = true;
  ...
  var createPreview = function createPreview2() {
    var buttonProps = mergeProps({
      className: cx("button"),
      onClick: show
    }, ptm("button"));
    if (props.preview) {
      return React14.createElement("div", buttonProps, content);
    }
    return null;
  };
  var createElement9 = function createElement10() {
    var downloadable = props.downloadable, alt2 = props.alt, crossOrigin2 = props.crossOrigin, referrerPolicy2 = props.referrerPolicy, useMap2 = props.useMap, loading2 = props.loading;
    ...
    var downloadIcon = IconUtils.getJSXIcon(props.downloadIcon || React14.createElement(DownloadIcon, null), _objectSpread2({}, downloadIconProps), {
      props
    });
    var rotateRightIcon = IconUtils.getJSXIcon(props.rotateRightIcon || React14.createElement(RefreshIcon, null), _objectSpread2({}, rotateRightIconProps), {
      props
    });
    var rotateLeftIcon = IconUtils.getJSXIcon(props.rotateLeftIcon || React14.createElement(UndoIcon, null), _objectSpread2({}, rotateLeftIconProps), {
      props
    });
    var zoomOutIcon = IconUtils.getJSXIcon(props.zoomOutIcon || React14.createElement(SearchMinusIcon, null), _objectSpread2({}, zoomOutIconProps), {
      props
    });
    var zoomInIcon = IconUtils.getJSXIcon(props.zoomInIcon || React14.createElement(SearchPlusIcon, null), _objectSpread2({}, zoomInIconProps), {
      props
    });
    var closeIcon = IconUtils.getJSXIcon(props.closeIcon || React14.createElement(TimesIcon, null), _objectSpread2({}, closeIconProps), {
      props
    });
    ...
    return React14.createElement("div", maskProps, React14.createElement("div", toolbarProps, downloadable && React14.createElement("button", downloadButtonProps, downloadIcon), React14.createElement("button", rotateRightButtonProps, rotateRightIcon), React14.createElement("button", rotateLeftButtonProps, rotateLeftIcon), React14.createElement("button", zoomOutButtonProps, zoomOutIcon), React14.createElement("button", zoomInButtonProps, zoomInIcon), React14.createElement("button", closeButtonProps, closeIcon)), React14.createElement(CSSTransition2, _extends8({
      nodeRef: previewRef
    }, transitionProps), React14.createElement("div", previewContainerProps, React14.createElement("img", _extends8({
      alt: alt2
    }, previewProps)))));
  };
  ...
  var src = props.src, alt = props.alt, width = props.width, height = props.height, crossOrigin = props.crossOrigin, referrerPolicy = props.referrerPolicy, useMap = props.useMap, loading = props.loading;
  var element = createElement9();
  var iconProp = mergeProps({
    className: cx("icon")
  }, ptm("icon"));
  var icon = props.indicatorIcon || React14.createElement(EyeIcon, iconProp);
  var indicatorIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, iconProp), {
    props
  });
  var content = props.template ? ObjectUtils.getJSXElement(props.template, props) : indicatorIcon;
  var preview2 = createPreview();
  ...
  var image = props.src && React14.createElement("img", _extends8({}, imageProp, {
    alt
  }));
  ...
  return React14.createElement("span", rootProps, image, preview2, maskVisibleState && React14.createElement(Portal, {
    element,
...
//# sourceMappingURL=primereact_image.js.map
